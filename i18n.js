...
(function () {
    ...
    var STRINGS = {
        ro: {
            ...
            'availability.title': 'Sunt liberă atunci?',
            'availability.sub': 'Alege data evenimentului și vezi pe loc dacă ziua e liberă. Fără formular lung și fără așteptare.',
            'availability.legend.free': 'Liberă',
            'availability.legend.busy': 'Ocupată',
            ...
            'availability.free.title': '{date} e liberă.',
            ...
            'availability.aria.free': 'liberă',
            'availability.aria.busy': 'ocupată',
