...
(function () {
    ...
    var STRINGS = {
        ro: {
            ...
            'availability.sub': 'Vezi dintr-o privire ce zile sunt libere. Fără formular lung și fără așteptare.',
            ...
            'availability.aria.unchecked': 'apasă ca să verific',
            'availability.aria.checking': 'verific',
            'availability.hint': 'Zilele libere au punct verde. Apasă pe una ca să-mi scrii despre ea.',
            'availability.checking': 'Verific…',
            'availability.busy.title': 'Sunt ocupat pe {date}.',
            'availability.busy.body': 'Scrie-mi oricum — poate găsim o dată apropiată.',
            'availability.error.title': 'Nu pot verifica acum.',
            'availability.error.body': 'Încearcă din nou peste câteva momente sau scrie-mi direct.',
        ...
        en: {
            ...
            'availability.sub': 'See at a glance which days are free. No long form, no waiting.',
            ...
            'availability.aria.unchecked': 'tap to check',
            'availability.aria.checking': 'checking',
            'availability.hint': 'Free days have a green dot. Tap one to message me about it.',
            'availability.checking': 'Checking…',
            'availability.busy.title': 'I’m booked on {date}.',
            'availability.busy.body': 'Message me anyway — we may find a nearby date.',
            'availability.error.title': 'I can’t check right now.',
            'availability.error.body': 'Try again in a moment, or just send me a message.',
